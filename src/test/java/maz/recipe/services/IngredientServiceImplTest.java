...
import maz.recipe.converters.IngredientCommandToIngredient;
import maz.recipe.converters.IngredientToIngredientCommand;
import maz.recipe.converters.UnitOfMeasureCommandToUnitOfMeasure;
...
public class IngredientServiceImplTest {
    ...
    public void testSaveRecipeCommand() {
        ...
        //then
        assertEquals(new Long(3L), savedCommand.getId());
        verify(recipeRepository, times(1)).findById(anyLong());
